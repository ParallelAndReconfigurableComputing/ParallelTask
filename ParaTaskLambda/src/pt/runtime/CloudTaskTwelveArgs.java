...
public class CloudTaskTwelveArgs<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> extends AbstractCloudTask<R> {
	...
	private T3 paramThree = null;		private T4 paramFour = null;		private T12 paramTweleve = null;
	...
	public TaskID<R> start(T1 paramOne, T2 paramTwo, T3 paramThree, T4 paramFour, T5 paramFive, T6 paramSix, T7 paramSeven, T8 paramEight, T9 paramNine,
		...
		this.paramThree = paramThree;	this.paramFour = paramFour;			this.paramTweleve = paramTwelve;
	...
	protected void customizedExecution(Object proxy) throws Throwable {
		this.futureResult = (Future<R>) this.invokedMethod.invoke(this.remoteInterface.cast(proxy), this.paramOne, this.paramTwo, this.paramThree, this.paramFour,
				this.paramFive, this.paramSix, this.paramSeven, this.paramEight, this.paramNine, this.paramTen, this.paramEleven, this.paramTweleve);
	}
}
