...
public class CloudTaskElevenArgs<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> extends AbstractCloudTask<R> {
	...
	private T9 paramNine = null;		private T10 paramTen = null;		private T11 paramEleven = null;
	
	public CloudTaskElevenArgs(boolean hasNoReturn, String remoteIP, String remotePort, String userName,
	...
	public TaskID<R> start(T1 paramOne, T2 paramTwo, T3 paramThree, T4 paramFour, T5 paramFive, T6 paramSix, T7 paramSeven, T8 paramEight, T9 paramNine, T10 paramTen, T11  paramEleven){
		...
		this.paramNine = paramNine;		this.paramTen = paramTen;		this.paramEleven = paramEleven;
	...
	protected void customizedExecution(Object proxy) throws Throwable {
		...
		this.futureResult = (Future<R>) this.invokedMethod.invoke(this.remoteInterface.cast(proxy), p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11);
	}
}
