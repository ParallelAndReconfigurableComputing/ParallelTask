...
import pt.hybridWrappers.PtCollectionObject;
import pt.hybridWrappers.PtIterator;
import pt.runtime.TaskID;

public class PtHybridList<E> implements List<E> {
	...
	public PtHybridList(List<E> originalCollection){
