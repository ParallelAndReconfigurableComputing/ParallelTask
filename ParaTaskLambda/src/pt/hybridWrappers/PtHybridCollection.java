...
public class PtHybridCollection<T> implements Collection<T>, Iterable<T> {
	...
	public Object clone(){
		PtHybridCollection<T> newCollection = new PtHybridCollection<>();
		for(PtCollectionObject<T> obj : thisCollection){
