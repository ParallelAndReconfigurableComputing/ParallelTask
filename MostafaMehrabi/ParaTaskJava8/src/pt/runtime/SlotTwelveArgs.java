...
class SlotTwelveArgs<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> extends Slot<R>{
	...
	SlotTwelveArgs(FunctorTwelveArgsNoReturn<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> functorNoReturn){
		this.functorNoReturn = functorNoReturn;
	}
	
	SlotTwelveArgs(FunctorTwelveArgsWithReturn<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> functorWithReturn) {
		this.functorWithReturn = functorWithReturn;
	}
	
	R execute(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8, T9 arg9, T10 arg10, T11 arg11, T12 arg12){
