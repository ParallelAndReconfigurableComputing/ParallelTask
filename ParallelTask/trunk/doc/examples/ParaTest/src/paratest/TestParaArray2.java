 ...
 *///####[21]####
public class TestParaArray2 extends Test {//####[22]####
//####[22]####
...
//####[29]####
    public TestParaArray2(int threads, int size, int stride) {//####[29]####
        fThreads = threads;//####[30]####
        fSize = size;//####[31]####
        fStride = stride;//####[32]####
    }//####[33]####
...
//####[53]####
    ...
    public void __pt__process() {//####[53]####
        ...
        for (int i = fSize * (taskID / fThreads); i < fSize * ((taskID + 1) / fThreads); i += fStride) //####[56]####
        {//####[56]####
            fArray[i]++;//####[57]####
        }//####[58]####
    }//####[59]####
