...
public class ModePanel extends JPanel implements ActionListener {
	...
	private JLabel lblParallelOn = new JLabel(new ImageIcon("images/parallelOn.png"));
	private JLabel lblSequentialOn = new JLabel(new ImageIcon("images/parallelOff.png"));
