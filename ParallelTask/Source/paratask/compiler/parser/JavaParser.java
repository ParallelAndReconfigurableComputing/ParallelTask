...
package paratask.compiler.parser;

import paratask.compiler.pt.*;
import java.io.*;
import java.util.*;
import paratask.compiler.parser.ast.*;
import paratask.compiler.parser.ast.body.*;
import paratask.compiler.parser.ast.expr.*;
import paratask.compiler.parser.ast.stmt.*;
import paratask.compiler.parser.ast.type.*;
 ...
 */
  ...
  final public TaskDeclaration TaskDeclaration() throws ParseException {
        Modifier modifier;
        MethodDeclaration method;
        String multiTaskSize = "-";
        boolean isInteractive = false;
        String smartCutoff = "-1";
        Expression name;
        NameExpr name2;
    switch (jj_nt.kind) {
    case SMART:
    case TASK:
        ...
        case LPAREN:
          ...
          case INTEGER_LITERAL:
            jj_consume_token(INTEGER_LITERAL);
                                                    smartCutoff = token.image;
            break;
          case IDENTIFIER:
            name2 = Name();
                                                  smartCutoff = name2.toString();
            break;
          default:
            jj_la1[41] = jj_gen;
            jj_consume_token(-1);
      ...
      case LPAREN:
        if (jj_2_9(2147483647)) {
          ...
          jj_consume_token(LPAREN);
          name = Expression();
                                                  multiTaskSize = name.toString();
          jj_consume_token(RPAREN);
        } else if (jj_2_11(2147483647)) {
          jj_consume_token(LPAREN);
          jj_consume_token(INTEGER_LITERAL);
                                                multiTaskSize = token.image;
          jj_consume_token(RPAREN);
        } else {
          jj_consume_token(-1);
          throw new ParseException();
      ...
      break;
    case TASK_INTERACTIVE:
      jj_consume_token(TASK_INTERACTIVE);
                                     isInteractive = true;
      switch (jj_nt.kind) {
      case LPAREN:
    ...
    modifier = Modifiers();
    method = MethodDeclaration(modifier);
          {if (true) return new TaskDeclaration(method.getBeginLine(), method.getBeginColumn(), method.getJavaDoc(), modifier.modifiers, method, multiTaskSize, isInteractive, smartCutoff);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public PrimitiveType PrimitiveType() throws ParseException {
    ...
    case INT:
      jj_consume_token(INT);
          ret = new PrimitiveType(token.beginLine, token.beginColumn, PrimitiveType.Primitive.Integer);
      break;
    case LONG:
 ...
 */
  ...
  final public TaskClauseExpr TaskClauseExpression() throws ParseException {
        TaskClauseExpr ret;
        Expression exp;
        PT_DependsOn deps = null;
        PT_Notify nots = null;
        PT_Notify notInts = null;
        PT_Handler hans = null;
        List args = null;
    exp = Expression();
    label_25:
    while (true) {
      ...
      case DEPENDSON:
        ...
        args = ArgumentList();
        jj_consume_token(RPAREN);
                                                            if (deps==null) deps = new PT_DependsOn(); deps.addDeps(args);
        break;
      case NOTIFY:
        jj_consume_token(NOTIFY);
        jj_consume_token(LPAREN);
        args = NotifyArgumentList(false,false);
        jj_consume_token(RPAREN);
                                                                                 if (nots == null) nots = new PT_Notify(); nots.addNotifies(args);
        break;
      case NOTIFYGUI:
        jj_consume_token(NOTIFYGUI);
        jj_consume_token(LPAREN);
        args = NotifyArgumentList(true,false);
        jj_consume_token(RPAREN);
                                                                            if (nots == null) nots = new PT_Notify(); nots.addNotifies(args);
        break;
      case NOTIFYINTER:
        jj_consume_token(NOTIFYINTER);
        jj_consume_token(LPAREN);
        args = NotifyArgumentList(false,true);
        jj_consume_token(RPAREN);
                                                                              if (notInts == null) notInts = new PT_Notify(); notInts.addNotifies(args);
        break;
      case NOTIFYINTERGUI:
        jj_consume_token(NOTIFYINTERGUI);
        jj_consume_token(LPAREN);
        args = NotifyArgumentList(true,true);
        jj_consume_token(RPAREN);
                                                                                if (notInts == null) notInts = new PT_Notify(); notInts.addNotifies(args);
        break;
      case TRYCATCH:
        jj_consume_token(TRYCATCH);
        jj_consume_token(LPAREN);
        args = HandlerArgumentList();
        jj_consume_token(RPAREN);
                                                                   if (hans == null) hans = new PT_Handler(); hans.addHandlers(args);
        break;
      default:
        jj_la1[66] = jj_gen;
        jj_consume_token(-1);
      ...
      default:
        ...
        break label_25;
          ...
          {if (true) return new TaskClauseExpr(exp.getBeginLine(), exp.getBeginColumn(), exp, deps, nots, notInts, hans);}
    throw new Error("Missing return statement in function");
  }
...
// this.
  ...
  final public List HandlerArgumentList() throws ParseException {
        List ret = new LinkedList();
        HandlerArg arg = null;
    arg = HandlerArgument();
                                  ret.add(arg);
  ...
  final public HandlerArg HandlerArgument() throws ParseException {
        NameExpr name = null;
        NotifyArg handler = null;
    if (jj_2_37(2147483647)) {
      name = Name();
      handler = NotifyArgument();
                                                           {if (true) return new HandlerArg(name.toString(), handler);}
    } else {
      switch (jj_nt.kind) {
      case BOOLEAN:
      case BYTE:
      ...
      case 138:
        handler = NotifyArgument();
                                             {if (true) return new HandlerArg("Exception", handler);}
        break;
      default:
        jj_la1[106] = jj_gen;
        jj_consume_token(-1);
  ...
  final public List NotifyArgumentList(boolean guiNotify, boolean intermediate) throws ParseException {
        List ret = new LinkedList();
        NotifyArg arg = null;
    arg = NotifyArgument();
                arg.setGuiNotify(guiNotify);
                arg.setInterNotify(intermediate);
                ret.add(arg);
    label_39:
    while (true) {
      switch (jj_nt.kind) {
  ...
  final public NotifyArg NotifyArgument() throws ParseException {
        Expression inst = null;
        Expression slot = null;
    switch (jj_nt.kind) {
    case 138:
      jj_consume_token(138);
      slot = Expression();
                                        {if (true) return new NotifyArg(null, slot, true);}
      break;
    default:
      jj_la1[108] = jj_gen;
      if (jj_2_38(2147483647)) {
        ...
        slot = Expression();
                                                             {if (true) return new NotifyArg(inst, slot, false);}
      } else if (jj_2_39(2147483647)) {
        inst = Expression();
        jj_consume_token(138);
        slot = Expression();
                                                            {if (true) return new NotifyArg(inst, slot, true);}
      } else {
        switch (jj_nt.kind) {
        case BOOLEAN:
        case BYTE:
        ...
        case MINUS:
          slot = Expression();
                                      {if (true) return new NotifyArg(null, slot, false);}
          break;
        default:
          jj_la1[109] = jj_gen;
          jj_consume_token(-1);
...
/* Annotation Types. */
  ...
  private boolean jj_3R_158() {
    if (jj_scan_token(TRYCATCH)) return true;
    if (jj_scan_token(LPAREN)) return true;
  ...
  private boolean jj_3R_157() {
    if (jj_scan_token(NOTIFYINTERGUI)) return true;
    if (jj_scan_token(LPAREN)) return true;
  ...
  private boolean jj_3R_156() {
    if (jj_scan_token(NOTIFYINTER)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_3R_199()) return true;
    if (jj_scan_token(RPAREN)) return true;
    return false;
  ...
  private boolean jj_3R_155() {
    if (jj_scan_token(NOTIFYGUI)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_3R_199()) return true;
    if (jj_scan_token(RPAREN)) return true;
    return false;
  ...
  private boolean jj_3R_153() {
    if (jj_scan_token(DEPENDSON)) return true;
    if (jj_scan_token(LPAREN)) return true;
  ...
  private boolean jj_3R_270() {
    if (jj_scan_token(TASK_INTERACTIVE)) return true;
    Token xsp;
    xsp = jj_scanpos;
  ...
  private boolean jj_3R_290() {
    if (jj_scan_token(SMART)) return true;
    Token xsp;
    xsp = jj_scanpos;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x48101000,0x1,0x0,0x0,0x0,0x40001000,0x8100000,0x48101000,0x100000,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x4a195000,0x0,0x0,0x0,0x0,0x0,0x10000000,0x0,0x4a195000,0x8100000,0x2094000,0x4a195000,0x0,0x0,0x0,0x0,0x22094000,0x22094000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x42095000,0x0,0x0,0x0,0x0,0x0,0x22094000,0x6359f000,0x0,0x2094000,0x2094000,0x0,0x2094000,0x10000000,0x10000000,0x2094000,0x2094000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x22094000,0x0,0x0,0x22094000,0x0,0x0,0x0,0x0,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x20000000,0