...
public class ParaTask {
	...
	public static enum ScheduleType { 
		...
		/**
		 * 	New: WorkFirst. A variation of WorkStealing. However, when meeting certain conditions, a task may be
		 * 	subject to being processed sequentially instead of being enqueued.
		 */
		WorkFirst
	...
	* @author Kingsley
	...
	/**
	 * 	Used to toggle the Work-First implementation.
	 * 	NOTE: HWERE TO PUT THIS?
	 */
	public static void setWorkFirst(boolean isWorkFirst) {
