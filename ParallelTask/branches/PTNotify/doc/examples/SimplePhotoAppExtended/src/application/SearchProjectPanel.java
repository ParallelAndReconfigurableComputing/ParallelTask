...
//####[56]####
    private JButton btnSearch = new JButton(new ImageIcon("images/search.png"));//####[56]####
//####[57]####
    private JButton btnStop = new JButton(new ImageIcon("images/stop.png"));//####[57]####
//####[58]####
    private JSpinner spnResultsPerPage;//####[58]####
//####[59]####
    private JLabel lblResPP = new JLabel("#pics");//####[59]####
//####[61]####
    private JButton btnNext = new JButton(new ImageIcon("images/right.png"));//####[61]####
//####[62]####
    private JButton btnPrev = new JButton(new ImageIcon("images/left.png"));//####[62]####
//####[63]####
