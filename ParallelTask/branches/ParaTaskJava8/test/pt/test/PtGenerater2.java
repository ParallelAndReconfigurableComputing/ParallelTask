...
public class PtGenerater2 {

	private static final String[] TEMPLATE_FILE = {"TestMixedTaskTemplate"};
	
	private static final String[] GENERATE_FILE = {"TestMixedTask.ptjava"};
