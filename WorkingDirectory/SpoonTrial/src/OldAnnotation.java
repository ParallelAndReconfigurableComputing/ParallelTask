...
public class OldAnnotation {
    ...
    public static void main(String[] args) {
        pt.runtime.TaskInfoNoArgs<Integer> __VarPtTask__ = ((pt.runtime.TaskInfoNoArgs<Integer>)(pt.runtime.ParaTask.asTask(pt.runtime.ParaTask.TaskType.MULTI ,
			(pt.functionalInterfaces.FunctorNoArgsWithReturn<Integer>)() -> OldAnnotation.foo3(10))));
        ...
        try {
			...
			(pt.functionalInterfaces.FunctorOneArgWithReturn<Integer, Integer>)(__iPtNonLambdaArg__) -> { try
 				 {  
						return OldAnnotation.foo2(__iPtNonLambdaArg__);
 				 }catch(Exception e){
						e.printStackTrace();
						return null; 
  				 }
			...
			(pt.functionalInterfaces.FunctorTwoArgsWithReturn<Integer, Integer, pt.runtime.TaskID<Integer>>)(__VarXPtNonLambdaArg__, __VarPtLambdaArg__) -> { try
 				 {  
						return OldAnnotation.foo1(__VarXPtNonLambdaArg__ ,__VarPtLambdaArg__.getReturnResult());
 				 }catch(Exception e){
						e.printStackTrace();
						return null; 
  				 }
			...
			(pt.functionalInterfaces.FunctorOneArgWithReturn<Integer, pt.runtime.TaskID<Integer>>)(__Var2PtLambdaArg__) -> { try
 				 {  
						return OldAnnotation.foo2(__Var2PtLambdaArg__.getReturnResult());
 				 }catch(Exception e){
						e.printStackTrace();
						return null; 
  				 }
            ...
            System.out.println(("The result of Var2 + Var3 is: " + (__Var2PtTaskID__.getReturnResult() + __Var3PtTaskID__.getReturnResult())));
