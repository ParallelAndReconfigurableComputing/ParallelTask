...
public class CollectionWrapperTest {
    ...
    public static void main(String[] args) {
        ...
        ParaTask.processingInParallel(true);
        List<java.lang.Integer>  _myList_ = pt.runtime.ParaTask.getPtWrapper(new ArrayList<java.lang.Integer> ());
        PtListWrapper<Integer> myList = (PtListWrapper<Integer>) _myList_;
        for (int i = 0 ; i < 20 ; i++) {
