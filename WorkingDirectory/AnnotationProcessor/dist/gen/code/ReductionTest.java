...
public class ReductionTest {
    ...
    public void process(int range) {
        ...
        pu.RedLib.IntegerSum __taskPtTaskReductionObjct__ = new pu.RedLib.IntegerSum();
        pt.runtime.ParaTask.setReductionOperationForTaskIDGroup(__taskPtTaskID__, __taskPtTaskReductionObjct__);
        ...
        pu.RedLib.MapUnion<java.lang.String, java.lang.Integer> __task2PtTaskReductionObjct__ = new pu.RedLib.MapUnion<java.lang.String, java.lang.Integer>(new pu.RedLib.IntegerMinimum());
        pt.runtime.ParaTask.setReductionOperationForTaskIDGroup(__task2PtTaskID__, __task2PtTaskReductionObjct__);
