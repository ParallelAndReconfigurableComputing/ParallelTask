...
public class FutureArrayTest {
    ...
    public static void main(java.lang.String[] args) {
        ...
        pu.RedLib.IntegerSum __arrayPtTaskReductionObject__ = new pu.RedLib.IntegerSum();
        pt.runtime.ParaTask.setReductionOperationForTaskIDGroup(__arrayPtTaskIDGroup__, __arrayPtTaskReductionObject__);
        for (int i = 0; i < 5; i++) {
        ...
        for (int __ptLoopIndex2__ = 0; __ptLoopIndex2__ < n; __ptLoopIndex2__++)
            array[__ptLoopIndex2__] = __arrayPtTaskIDGroup__.getInnerTaskResult(__ptLoopIndex2__);
