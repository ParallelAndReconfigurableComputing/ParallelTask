...
public class CollectionWrapperTest {
    static pt.wrappers.PtListWrapper<java.lang.Integer> myList;

    static java.util.List<java.lang.Integer> __myListPtTask__;
...

    {
        ...
        __myListPtTask__ = pt.runtime.ParaTask.getPtWrapper(new java.util.ArrayList<java.lang.Integer>());
        myList = (pt.wrappers.PtListWrapper<java.lang.Integer>) __myListPtTask__;
    }
}
