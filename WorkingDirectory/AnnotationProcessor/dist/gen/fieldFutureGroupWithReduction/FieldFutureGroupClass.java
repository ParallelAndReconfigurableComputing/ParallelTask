        ...
        for (int i = 0; i < (reps); i++) {
            for (int j = 0; j < (size); j++) {
                if (!__mapsPtTaskIDGroup__Synchronized) {
                    pt.runtime.TaskInfoOneArg<java.util.Map<java.lang.Integer, java.util.List<java.lang.String>>, Integer> ____maps_1__PtTask__ = ((pt.runtime.TaskInfoOneArg<java.util.Map<java.lang.Integer, java.util.List<java.lang.String>>, Integer>) (pt.runtime.ParaTask.asTask(pt.runtime.ParaTask.TaskType.ONEOFF, 
			(pt.functionalInterfaces.FunctorOneArgWithReturn<java.util.Map<java.lang.Integer, java.util.List<java.lang.String>>, Integer>)(__jPtNonLambdaArg__) -> task(__jPtNonLambdaArg__))));
