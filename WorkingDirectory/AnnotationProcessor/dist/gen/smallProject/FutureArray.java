...
public class FutureArray {
    private pt.runtime.TaskIDGroup<java.lang.Integer> __myArrayPtTaskIDGroup__ = new pt.runtime.TaskIDGroup<>();
    ...
    public void processInnerTasks() {
        ...
        int[] newArray;
        pt.runtime.TaskIDGroup<java.lang.Integer> __newArrayPtTaskIDGroup__ = new pt.runtime.TaskIDGroup<>();
        if (setArray) {
            newArray = new int[7];
        }else
            newArray = new int[8];
        ...
        for (int i = 0; i < (newArray.length); i++) {
            pt.runtime.TaskInfoOneArg<java.lang.Integer, java.lang.Integer> ____newArray_1__PtTask__ = ((pt.runtime.TaskInfoOneArg<java.lang.Integer, java.lang.Integer>) (pt.runtime.ParaTask.asTask(pt.runtime.ParaTask.TaskType.ONEOFF, ((pt.functionalInterfaces.FunctorOneArgWithReturn<java.lang.Integer, java.lang.Integer>) (( __iPtNonLambdaArg__) -> task(__iPtNonLambdaArg__))))));
            pt.runtime.TaskID<java.lang.Integer> ____newArray_1__PtTaskID__ = ____newArray_1__PtTask__.start(i);
